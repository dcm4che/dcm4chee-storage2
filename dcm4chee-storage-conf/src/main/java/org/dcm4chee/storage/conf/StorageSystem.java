...
public class StorageSystem {
    ...
    @ConfigurableProperty(name = "dcmStorageSystemMultipartUpload", defaultValue = "true")
    private boolean multipartUpload = true;

    @ConfigurableProperty(name = "dcmStorageSystemMultipartChunkSize", defaultValue = "32MB")
